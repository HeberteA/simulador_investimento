...
def display_full_results(results, show_save_button=False, show_download_button=False, save_callback=None, is_simulation_saved=False):
    ...
    with tab_resumo:
        ...
        with colu1:
            ...
            fig_gauge_anual.update_layout(height=250, paper_bgcolor='rgba(0,0,0,0)', margin=dict(l=50, r=50, t=50, b=10))
            ...
            fig_gauge_periodo.update_layout(paper_bgcolor='rgba(0,0,0,0)', height=250, margin=dict(l=50, r=50, t=50, b=10))
